...
import { useBanners, useRecommend } from '@/hooks'
...
const Recommend = () => {
  ...
  const { data: recommendData, isLoading: isRecommendLoading } = useRecommend()
  const { data: bannersData, isLoading: isBannerLoading } = useBanners()
